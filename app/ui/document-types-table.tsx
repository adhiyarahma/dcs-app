    ...
    <div className="space-y-5">
      ...
      {filterCategory && (
        <div className="flex items-center gap-2 text-xs flex-wrap">
          ...
          <span className="px-2 py-0.5 bg-indigo-50 text-indigo-700 rounded-full font-medium border border-indigo-100">
            {activeCategoryName}
          </span>
        </div>
      )}
        ...
        >
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <select
                name="category_id"
                defaultValue={editItem?.category_id ?? filterCategory}
                required
